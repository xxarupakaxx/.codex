...
description: 明示的な日報・日記依頼に対し、05_log.md等の作業ログから成果、課題、明日のTODO、KPTをまとめるスキル。複数PJを横断する場合は設定済みの対象だけを読む。「日報」「今日のまとめ」「日記」「1日の振り返り」などで使う。
---
...
ログの量や複雑さに応じて、現在利用できる要約手段を選び、以下を生成する。委任する場合も対象ログ、出力範囲、機密情報の扱いを明示する:
