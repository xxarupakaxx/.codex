...
- [ ] 不要ファイルが削除済み
- [ ] @参照が正しく設定済み
- [ ] 用語・導線の置換を伴う同期では、置換対象語彙で `rg` 横断検索を行いヒットゼロを確認済み（部分置換で旧記述が残存しレビュー指摘された実失敗より。出典: memories/raw_memories.md:1914「active guidance 全体を横断検索してから完了判定」、memories/memory_summary.md:32-33）
