...
- **Model-invoked**: `research`、`tdd`、`diagnosing-bugs`、`code-review`、`ubiquitous-language`、`verification-loop`、`consult-fable` など、現在の作業を小さく安全に進める規律。タスクに合う場合だけ使い、結果を短く報告する。
