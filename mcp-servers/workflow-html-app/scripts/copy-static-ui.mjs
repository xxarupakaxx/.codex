...
const stagingDir = resolveSafeTempDir(
  process.env.WORKFLOW_HTML_APP_UI_OUT_DIR || ".tmp-ui-build",
  "WORKFLOW_HTML_APP_UI_OUT_DIR",
);
...
export function publish(options = {}) {
  ...
  let bundleStage = mkdtempSync(join(packageRoot, ".tmp-ui-bundle-"));
  try {
