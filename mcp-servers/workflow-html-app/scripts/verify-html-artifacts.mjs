...
const sourcePathByFile = {
  "plan-viewer.html": "mcp-servers/workflow-html-app/ui/plan-viewer.html",
  "diagram-viewer.html": "mcp-servers/workflow-html-app/ui/diagram-viewer.html",
  "verification-viewer.html": "mcp-servers/workflow-html-app/ui/verification-viewer.html",
};
...
function readManifest() {
  ...
  const producer = manifest.producers.find(
    (entry) => entry.id === "mcp-workflow-html-app",
  );
  if (!producer) {
    throw new Error("mcp-workflow-html-app producer missing from html-surfaces manifest");
  }
